...
The goal of `charport` is to remove that materialization cost by making ALTREP strings interoperable between packages. The hope is that ALTREP strings stop being a package-local optimization and become something packages share.
...
- [Error handling](https://charport.github.io/charport/articles/error-handling.html), for a deeper dive into error handling.
