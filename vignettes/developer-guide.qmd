...
| C++ value | C value | Meaning |
|-------------------------|---------------------|--------------------------|
| `cetype_ext_t::CE_NATIVE` | `CETYPE_EXT_NATIVE` | Native encoding based on machine locale. |
| `cetype_ext_t::CE_UTF8` | `CETYPE_EXT_UTF8` | UTF-8. |
| `cetype_ext_t::CE_LATIN1` | `CETYPE_EXT_LATIN1` | Latin-1. |
| `cetype_ext_t::CE_BYTES` | `CETYPE_EXT_BYTES` | Bytes encoding. |
| `cetype_ext_t::CE_ASCII_OR_UTF8` | `CETYPE_EXT_ASCII_OR_UTF8` | ASCII/UTF-8-compatible bytes. |
| `cetype_ext_t::CE_ASCII` | `CETYPE_EXT_ASCII` | ASCII bytes, equivalent to `Rf_charIsASCII(x)`. |
| `cetype_ext_t::CE_NA` | `CETYPE_EXT_NA` | Missing string. `ptr` is `NULL` and `len` is `NA_INTEGER`. |
